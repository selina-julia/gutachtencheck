...
export default function UploadLayout({
  ...
  return (
    /* Volle Fensterhöhe ohne Seitenscroll: Der Assistent bringt seinen
       eigenen Scrollbereich mit, damit die Ablagefläche die Höhe bekommt. */
    <div className="flex h-dvh flex-col overflow-hidden bg-background">
      <header className="border-b border-border">
        <div className="mx-auto flex h-14 max-w-[1520px] items-center px-5 sm:px-8">
          <Link
            href="/"
      ...
      <footer className="border-t border-border">
        <div className="mx-auto flex max-w-[1520px] flex-col gap-2 px-5 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-8">
